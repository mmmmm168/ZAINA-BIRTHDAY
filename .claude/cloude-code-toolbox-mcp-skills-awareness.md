...
_Generated: 2026-08-21T11:46:02.113Z_
...
Workspace `mcp.json` _(folder: BIRTHDAY WISHES)_

- **c:\Users\Administrator\BIRTHDAY WISHES\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Administrator\.claude.json** — _File exists — no servers defined_
